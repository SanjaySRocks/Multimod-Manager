...
AddDefaultMenus()
{
	new flags;
#if defined MULTIMOD
	AddMenu("MOD_MENU", "amx_modmenu", get_clcmd_flags("amx_modmenu", flags) ? flags : ADMIN_MAP, "Multimod Manager")
#endif
	AddMenu("KICK_PLAYER", "amx_kickmenu", get_clcmd_flags("amx_kickmenu", flags) ? flags : ADMIN_KICK , "Players Menu")
#if defined ULTIMATEBANS
	AddMenu("BAN_PLAYER", "amx_banmenu", get_clcmd_flags("amx_banmenu", flags) ? flags : ADMIN_BAN, "Ultimate Bans")
	AddMenu("UNBAN_PLAYER", "amx_unbanmenu", get_clcmd_flags("amx_unbanmenu", flags) ? flags : ADMIN_BAN, "Ultimate Bans")
#else	
...
#if defined MULTIMOD
	//----Multimod Manager--------
	AddMenu("CHANGEL", "amx_mapmenu", get_clcmd_flags("amx_mapmenu", flags) ? flags : ADMIN_MAP, "Multimod Manager")
	AddMenu("VOTE_MAPS", "amx_votemapmenu", get_clcmd_flags("amx_votemapmenu", flags) ? flags : ADMIN_VOTE, "Multimod Manager")
	//----Multimod Manager End----
#else
